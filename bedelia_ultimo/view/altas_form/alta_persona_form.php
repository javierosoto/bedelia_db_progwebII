...
<body>
		...
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span8">
					<form name="alta_persona_form" action="../funcion_sql/altas/alta_persona_sql.php" method="post">
						<fieldset>
							<legend>Alta</legend>
							...
							<input type="text" name="nro_doc_form" required placeholder="Documento" pattern="[0-9]{8}" tittle="Solamente numeros y 8 digitos"/>
							<br>
							<label align="left">Apellido</label>
							<!-- ingresar el apellido que luego se concatenara con el nombre -->
							<input type="text" name="apellido_form" required placeholder="Apellido" pattern="[a-zA-z]+" tittle="Solamente letras"/>
							<br>
							<label align="left">Nombre/s</label>
							<!-- ingresa el nombre -->
							<input type="text" name="nombre_form"  required placeholder="Nombre" pattern="[a-zA-z]+" tittle="Solamente letras"/>
							<br>
