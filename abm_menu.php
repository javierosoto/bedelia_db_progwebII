...
<nav class="navbar navbar-default" role="navigation">
	...
	<ul class="nav navbar-nav">
		<li class="dropdown">
			...
			<ul class="dropdown-menu">
				<li><a href="altas_form/alta_carrera_form.php">Alta</a></li>
				<li><a href="bajas_form/baja_carrera_form.php">Baja</a></li>
				<li><a href="mod_form/mod_carrera_form.php">Modifica</a></li>
			</ul>
		</li>
	</ul>
